(module hierlist-unit racket/base
  ...
  (define sort* sort)
  (define-runtime-path turn-up-path "turn-up.png")
  (define-runtime-path turn-down-path "turn-down.png")
  (define turn-up (fit turn-up-path))
  (define turn-down (fit turn-down-path))
  (define turn-up-click turn-up)
  (define turn-down-click turn-down) 

(module hierlist-unit racket/base
  ...
  (define turn-up (include-bitmap "turn-up.png" 'png/mask))
  (define turn-down (include-bitmap "turn-down.png" 'png/mask))
  (define turn-up-click (include-bitmap "turn-up-click.png" 'png/mask))
  (define turn-down-click (include-bitmap "turn-down-click.png" 'png/mask))
